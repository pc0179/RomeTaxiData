...
execution_str = "SELECT * FROM rometaxidata WHERE sim_day_num = 10 AND taxi_id = 305"
#execution_str = "SELECT DISTINCT taxi_id FROM rometaxidata"
...
"""
######--------------------------------------------~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-----
# part of week 2 plots, ie how many taxis per day/hour in trace data
# what's the distribution of gps point updates (ie time between data points)
